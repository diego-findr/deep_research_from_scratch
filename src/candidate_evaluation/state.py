...
the multi-agent candidate evaluation workflow, including agent evaluations,
debate messages, and consensus decisions.
"""
...
class CandidateEvaluationState(TypedDict):
    ...
    This state tracks the enriched candidate and job data, individual agent
    evaluations, debate messages, questions, consensus decision, and complete
